...
function Footer() {
    return (
        <div style={{ background: "rgb(49,48,53)" }}>
            <Container>
                <Row style={{ padding: "3%" }}>
                    <Col xs={2} className="col__styling">
                        <img src="https://in.bmscdn.com/webin/common/icons/hut.svg" />
                        List Your Show
                    </Col>
                    <Col xs={7} className="col__styling">
                ...
                <Row style={{ textAlign: "center", padding: "3%", background: "rgb(64,64,67)", color: "white", width: "100%" }}>
                    <Col>
